...
const ForgotPassword: React.FC = () => {
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    // Demo-mode: simulate sending OTP without backend support
    setStep('otp');
    setMessage('OTP has been sent to your email address (demo mode).');
    setLoading(false);
  };
  ...
  const handleOtpSubmit = async (e: React.FormEvent) => {
    ...
    // For OTP verification, we'll just move to the next step
